...
# 🚀 BG Deployer: A Shell-Based Blue-Green Deployment Solution  
...
|------------------|--------------|------------------------|-----------------------|---------------------|------------------------------------------------|  
| `TechTeam`       | Yes          | project-abc            | project-abc           | Static             | Identifies the project team.                   |  
| `Environment`    | Yes          | Staging                | Staging               | Static             | Defines the environment (e.g., Staging, Prod). |  
| `Stack`          | Yes          | myapp-stage            | myapp-stage           | Static & Unique    | Unique identifier for the app stack.           |  
| `Service`        | No           | myapp-stage-blue       | myapp-stage-green     | Static & Unique    | Used for remote Ansible runs.                  |  
| `BuildType`      | No           | rpm or jar             | rpm or jar            | Static             | Defines the type of build artifact.            |  
| `Cluster`        | Yes          | blue                   | green                 | Static             | Denotes the ASG type (blue/green).             |  
| `ActiveCluster`  | Yes          | blue                   | blue                  | Dynamic            | Dynamically updated during deployment.         |  
